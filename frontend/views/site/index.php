...
<hr>
	...
	<a href="<?php echo Url::to(['/product/addtocart'])?>" baseUrl="<?= Yii::$app->request->baseUrl?>" productid="<?= $product->productId?>" userid="<?= Yii::$app->user->id?>" class="btn btn-lg btn-outline-primary text-uppercase addtocart"> <i class="fas fa-shopping-cart"></i> Add to cart </a>
</article> <!-- card-body.// -->
		</aside> <!-- col.// -->
	</div> <!-- row.// -->
</div> <!-- card.// -->
